...
public:
    ...
    const QDir& getCurrentDirectory() const;
    void returnToDefault();

    std::pair<size_t, size_t> getNonogramSize() override;
    std::vector<DataInformation::additionCondLine> getAdditionalCondition() override;
    DataInformation::conditionLine getLineSequence(bool isColumn, size_t lineIndex) override;
